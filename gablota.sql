...
--
-- Host: 127.0.0.1
-- Czas generowania: 25 Mar 2020, 15:35
...
INSERT INTO `dostawcze` (`id`, `id_uzytkownika`, `Marka`, `Model`, `Rok_produkcji`, `Przebieg`, `Typ`, `Pojemnosc`, `Stan`, `Skrzynia`, `Moc`, `Naped`, `Paliwo`, `Kraj`, `Lokalizacja`, `Ladownosc`, `Cena`, `Data_dodania`) VALUES
(1, 4, 'Fiat', 'Ducato', 2017, 230000, 'Bus', 1999, 'Używane', 'Manual', 150, 'RWD', 'Diesel', 'Francja', 'Waszawa', 1700, 45000, '2020-03-25 14:34:09'),
(2, 2, 'Mercedes', 'Vito', 2014, 350000, 'Bus', 2999, NULL, 'Automat', 190, 'AWD', 'Benzyna', 'Polska', 'Białystok', 900, 60000, '2020-03-25 14:34:09'),
(3, 3, 'Volvo', 'FH420', 2015, 430200, 'TIR', 8978, 'Używane', 'Automat', 420, 'RWD', 'Diesel', NULL, 'Wrocław', NULL, 420000, '2020-03-25 14:34:09');
...
INSERT INTO `motocykle` (`id`, `id_uzytkownika`, `Marka`, `Model`, `Rok_produkcji`, `Przebieg`, `Typ`, `Pojemnosc`, `Stan`, `Skrzynia`, `Moc`, `Prawo_jazdy`, `Naped`, `Kraj`, `Lokalizacja`, `Miejsca`, `Cena`, `Data_dodania`) VALUES
(1, 1, 'KTM', 'Duke 125', 2017, 5400, 'Skuter', 124, 'Używane', 'Manual', 15, 'B', 'Łańcuch', 'Polska', 'Białystok', 1, 12000, '2020-03-25 14:27:23'),
(2, 4, 'Romet', 'Skuter 50', 2005, 23000, 'Skuter', 49, NULL, 'Automat', 3, 'AM', 'Pasek', NULL, 'Warszawa', 2, 1500, '2020-03-25 14:27:23'),
(3, 3, 'Ducati', 'Panigale V4', 2018, 10, 'Motor', 1199, 'Nowy', 'Manual', 230, 'A', 'Łańcuch', 'Polska', 'Warszawa', NULL, 230000, '2020-03-25 14:27:23');
...
INSERT INTO `osobowe` (`id`, `id_uzytkownika`, `Marka`, `Model`, `Rok_produkcji`, `Przebieg`, `Nadwozie`, `Pojemnosc`, `Stan`, `Skrzynia`, `Moc`, `Naped`, `Paliwo`, `Kraj`, `Lokalizacja`, `Miejsca`, `Cena`, `Data_dodania`) VALUES
(1, 1, 'VW', 'Scirocco', 2013, 102465, 'Coupe', 1998, 'Używane', 'Automat', 140, 'FWD', 'Diesel', 'Polska', 'Białystok', 4, 35000, '2020-03-25 14:16:51'),
(2, 3, 'Opel', 'Astra', 1995, 342100, 'Sedan', 1399, 'Używane', 'Manual', 75, 'FWD', 'Benzyna + LPG', 'Niemcy', 'Białystok', 5, 3400, '2020-03-25 14:16:51'),
(3, 2, 'Audi', 'RS6', 2020, 5, 'Kombi', 3998, 'Nowe', 'Automat', 560, 'AWD', 'Benzyna', 'Polska', 'Warszawa', 5, 340000, '2020-03-25 14:16:51'),
(4, 4, 'Fiat', 'Punto 1.2', 1993, 234000, 'Hatchback', 1194, NULL, 'Manual', 57, 'RWD', 'Benzyna', NULL, 'Warszawa', NULL, 700, '2020-03-25 14:18:25');
